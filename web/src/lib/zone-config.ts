...
export const PO_COSTUMES: Record<PoCostumeId, PoCostumeConfig> = {
  default: {
    ...
    portrait: "/sprites/po/codec_portrait_default.png",
  },
  craftsman: { sheetPath: "/sprites/po/costumes/craftsman_idle_sheet.png", label: "Craftsman Po", portrait: "/sprites/po/codec_portrait_craftsman.png" },
  artist:    { sheetPath: "/sprites/po/costumes/artist_idle_sheet.png",    label: "Artist Po",    portrait: "/sprites/po/codec_portrait_artist.png" },
  scholar:   { sheetPath: "/sprites/po/costumes/scholar_idle_sheet.png",   label: "Scholar Po",   portrait: "/sprites/po/codec_portrait_scholar.png" },
  messenger: { sheetPath: "/sprites/po/costumes/messenger_idle_sheet.png", label: "Messenger Po", portrait: "/sprites/po/codec_portrait_messenger.png" },
  sleepy:    { sheetPath: "/sprites/po/costumes/sleepy_idle_sheet.png",    label: "Sleepy Po",    portrait: "/sprites/po/codec_portrait_sleepy.png" },
  glitch:    { sheetPath: "/sprites/po/costumes/glitch_idle_sheet.png",    label: "Glitch Po",    portrait: "/sprites/po/codec_portrait_glitch.png" },
  moped: {
