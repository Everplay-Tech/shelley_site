        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="font-pixel text-[8px] text-white/70 group-hover:text-white transition-colors tracking-wider">DISCORD</p>
              <p className="text-white/35 text-xs">Community server &mdash; join the crew</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="font-pixel text-[8px] text-white/70 group-hover:text-white transition-colors tracking-wider">YOUTUBE</p>
              <p className="text-white/35 text-xs">Build logs &amp; music</p>
            </div>
          </a>
